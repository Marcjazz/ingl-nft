...
export function createSdk(): DialectSdk {
    ...
    const wallet = DialectWalletAdapterWrapper.create(NodeDialectWalletAdapter.create());
...
export async function getMessages(sdk: DialectSdk, threadId: ThreadId): Promise<ThreadMessage[]> {
